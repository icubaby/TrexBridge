          ...
          if (isQuick) {
            (async function () {
              try {
                ...
                var fragBase = { mode: "default", packets: "", length: "", interval: "", maxSplit: "", fragment: false, protocols: "vless" };
                var res = await fetch("/api/users", {
                  method: "POST",
                  headers: { "Content-Type": "application/json" },
                  credentials: "same-origin",
                  body: JSON.stringify({ username: uname, limit_gb: null, expiry_days: null, ips: ipsStr, port: "443,80", tls: "on", fingerprint: "ios", block_ads: 1, frag_len: JSON.stringify(fragBase), frag_int: "0", ip_count: 5, ip_operator: "all", user_socks5: null, auto_rotate_user_proxy: 0 })
                });
                var j = await res.json().catch(function () { return {}; });
...
function CreateView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var isLastOdd = idx === EXIT_COUNTRIES.length - 1 && EXIT_COUNTRIES.length % 2 === 1;
    return /*#__PURE__*/React.createElement("button", {
      key: c.code,
      type: "button",
      disabled: !!exitBusy,
      onClick: function () { pickExitCountry(c.code, c.label); },
      className: "text-[13px] font-black px-2.5 py-2.5 border-[2.5px] border-black shadow-[2px_2px_0_#000] text-white " + bg + (isLastOdd ? " col-span-2" : ""),
